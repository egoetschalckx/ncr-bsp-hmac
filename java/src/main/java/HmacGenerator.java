...
/**
 * A helper class that generates an HMAC token created with the parameters being
...
public class HmacGenerator {
     ...
     */
    public String generateHmac(String sharedKey, String secretKey, String date, String httpMethod, String requestUrl,
            String contentType, String nepApplicationKey, String nepCorrelationId, String nepOrganization,
